...
Read `README.md`, `docs/setup.md`, and `docs/backend-contract.md` before changes. The canonical project name is CleanVoice. This is a team hackathon prototype with an incomplete public backend, not a production service.
...
- No PocketBase hooks/schema/migrations are included. Never invent their behavior in documentation.
...
- Every booking remains tentative until a human confirms. Verify enforcement in the backend once it is recovered.
