...
CleanVoice is a local hackathon prototype. It is not ready to process real callers or to run as a public credentialed service. Known access-control and prototype boundaries are documented in the [README](README.md#limitations-and-boundaries).
