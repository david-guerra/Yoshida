    ...
    <main className="min-h-screen bg-[#f7f8f4] px-4 py-5 text-[#162018] sm:px-8">
      ...
      <section className="mx-auto max-w-6xl">
        ...
        <form action={createOrderAction} className="space-y-7">
          <div className="rounded-2xl border border-[#e1e6dd] bg-white p-5 shadow-sm sm:p-6">
          ...
          <div className="flex flex-wrap justify-end gap-3 border-t border-[#edf1ee] pt-5">
            <Link
              className="rounded-full border border-[#dfe7e2] bg-white px-4 py-2 text-sm font-semibold text-[#344238] shadow-sm hover:bg-[#f8fbf9]"
              href="/orders"
            >
              Cancel
            </Link>
